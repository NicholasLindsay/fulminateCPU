...
FUSE_1="C:/Users/Nicholas/Documents/Project Fulminate/FulminateSim/FulminateCPU2/FulminateCPU2.sim/sim_1/behav/top_sim.prj"

ExecStep fuse -intstyle pa -incremental -L work -L secureip -o top_sim.exe --prj "$FUSE_1" -top work.top_sim
